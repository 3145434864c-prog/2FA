...
document.addEventListener("DOMContentLoaded", function() {
    const contactForm = document.querySelector(".contact-form"); // tu formulario

    contactForm.addEventListener("submit", function(e) {
        e.preventDefault();

        const formData = new FormData();
        formData.append("nombre", document.getElementById("contact_name").value);
        formData.append("email", document.getElementById("contact_email").value);
        formData.append("mensaje", document.getElementById("contact_message").value);
